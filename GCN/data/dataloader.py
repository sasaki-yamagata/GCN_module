...
class DataFrameLoader:
    def __init__(self, df_path, target_props, end=None, start=None):
        ...
        x_data = [Data(x=feature, edge_index=edge_index, feature_size=feature_size)  
          for feature, edge_index, feature_size, in zip(df_data["feature_matrix"].values, df_data["edge_index"].values, df_data["feature_size"].values)]
